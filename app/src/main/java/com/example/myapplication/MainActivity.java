...
{
    public static String CYCLEVIEPREFS = "cycle_vie_prefs";
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnNouvelleActivite = (Button) findViewById(R.id.btnAct2);
        btnNouvelleActivite.setOnClickListener(btnActiviteOnClickListener);
